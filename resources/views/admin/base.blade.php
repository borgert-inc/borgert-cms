    ...
    <body class="fixed-sidebar">
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <!-- Footer -->
                <div class="footer">
                    <div class="pull-right"><a href="https://github.com/odirleiborgert/rocket-cms" target="_blank"><u>Open Source</u> <i class="fa fa-github"></i></a> - <strong>v.0.0.1</strong></div>
