...
@section('title', trans('admin/blog.comments.list.title', ['total' => $comments->total()]), @parent)

@section('comments')
    
    @section('subtitle', trans('admin/blog.comments.list.title', ['total' => $comments->total()]))
        ...
        <div class="mail-body">
            ...
            @else
                <div class="widget p-lg text-center">
                    ...
                    <h4 class="no-margins">@lang('admin/blog.comments.list.is_empty')</h4>
                </div>
            @endif
