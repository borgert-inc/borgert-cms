...
@section('title', trans('admin/blog.posts.list.title', ['total' => $posts->total()]), @parent)
...
@section('blog')
	...
	@section('subtitle', trans('admin/blog.posts.list.title', ['total' => $posts->total()]))
        ...
        <div class="ibox-content">
            ...
            @else
                <div class="widget p-lg text-center">
                    ...
                    <h4 class="no-margins">@lang('admin/blog.posts.list.is_empty')</h4>
                </div>
            @endif
        </div>
    </div>
