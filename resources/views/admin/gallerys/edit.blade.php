                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="status" class="form-control">
                                        <option value="1" {{ $gallery->status === 1 ? 'selected' : '' }}>@lang('admin/_globals.forms.active')</option>
                                        <option value="0" {{ $gallery->status === 0 ? 'selected' : '' }}>@lang('admin/_globals.forms.inactive')</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
