...
@section('title', trans('admin/gallerys.list.title', ['total' => $gallerys->total()]), @parent)
...
@section('gallerys')
	...
	@section('subtitle', trans('admin/gallerys.list.title', ['total' => $gallerys->total()]))
        ...
        <div class="ibox-content">
            ...
            @else
                <div class="widget p-lg text-center">
                    ...
                    <h4 class="no-margins">@lang('admin/gallerys.list.is_empty')</h4>
                </div>
            @endif
        </div>
    </div>
