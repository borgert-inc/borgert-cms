...
@section('title', 'Lista de categorias | Páginas ', @parent)

@section('actions')
	<a href="{{ route('admin.pages.categorys.create') }}" class="btn dim btn-primary"><i class="fa fa-plus"></i> Criar Categoria</a>
@endsection
                            ...
                            <tbody>
                                @foreach($categorys as $key => $category)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('admin.pages.categorys.edit',$category->id) }}" class="btn btn-primary">Editar</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
