...
@section('title', 'Cadastro de Conteúdo | Páginas ', @parent)

@section('actions')
    <a href="{{ route('admin.pages.contents.list') }}" class="btn btn-default"><i class="fa fa-angle-left"></i> Voltar</a>
@endsection

@section('pages')
	
	@section('subtitle', 'Cadastro de conteúdo')
