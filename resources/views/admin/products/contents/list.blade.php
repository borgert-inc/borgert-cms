...
@section('title', trans('admin/products.contents.list.title', ['total' => $contents->total()]) , @parent)
...
@section('products')
	...
	@section('subtitle', trans('admin/products.contents.list.title', ['total' => $contents->total()]))
        ...
        <div class="ibox-content">
            ...
            @else
                <div class="widget p-lg text-center">
                    ...
                    <h4 class="no-margins">@lang('admin/products.contents.list.is_empty')</h4>
                </div>
            @endif
        </div>
    </div>
