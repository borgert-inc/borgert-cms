...
@section('title', trans('admin/users.list.title', ['total' => $users->total()]), @parent)
...
@section('users')
    ...
    @section('subtitle', trans('admin/users.list.title', ['total' => $users->total()] ))
        ...
        <div class="ibox-content">
            ...
            @else
                <div class="widget p-lg text-center">
                    ...
                    <h4 class="no-margins">@lang('admin/users.list.is_empty')</h4>
                </div>
            @endif
        </div>
    </div>
